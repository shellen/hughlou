      ...
      <div className="mb-14">
        <div className="rounded-2xl overflow-hidden mb-8">
          ...
          <div className="flex items-stretch">
            <div className="bg-[#111113] pl-6 sm:pl-10 pr-0 flex items-center pb-6 pt-0">
              <p
            ...
            <div className="bg-[#2563eb] pl-[0.4em] pr-4 sm:pr-6 flex items-center flex-1 rounded-tl-xl pb-6 pt-0">
              <p
                className="text-[clamp(1.75rem,5.5vw,3.5rem)] font-black text-white uppercase leading-none tracking-tight"
                style={{ fontFamily: "'Outfit', sans-serif" }}
              >
